  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function HomeComponent(weatherService, photoService) {
        ...
        this.photoService.getRandomPhoto('nature', 'portrait', 3).subscribe(function (data) {
          var photoData = data;
          ...
          try {
            for (var _iterator = photoData[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              _this.photoCollection.push(elt.urls.small);
            }
          } catch (err) {
    ...
    function () {
      ...
      _createClass(PhotoService, [{
        ...
        value: function getRandomPhoto(query, orientation, count) {
          return this.unsplashApi.get("/random?query=".concat(query, "&orientation=").concat(orientation, "&count=").concat(count));
        }
      }, {
